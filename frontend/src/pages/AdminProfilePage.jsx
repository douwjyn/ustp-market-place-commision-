        ...
        <div className="max-w-7xl mx-auto h-full">
          <div className="flex gap-6 h-full">
            {/* <aside className="w-48 flex-shrink-0">
              <nav>
                 <button onClick={handleNavigate('/admin/dashboard')} className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-4 py-3 rounded-lg text-sm font-medium shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-105">
                  Home
                </button>
              </nav>
            </aside> */}
